...
class MedCareTrainer(Trainer):
    ...
    def _save_checkpoint(self, model, trial, metrics=None):
        if getattr(self.args, 'tne_mm_mlp_adapter', False):
            ...
            super(MedCareTrainer, self)._save_checkpoint(model, trial, metrics)
            ...
            run_dir = self._get_output_dir(trial=trial)
            output_dir = os.path.join(run_dir, checkpoint_folder)
            keys_to_match = ["mlp.gate_proj.base", "mlp.gate_proj.orth", "mlp.up_proj.base", "mlp.up_proj.orth", "mlp.down_proj.base", "mlp.down_proj.orth"]
    ...
    def _save(self, output_dir: Optional[str] = None, state_dict=None):
        if getattr(self.args, 'tune_mm_mlp_adapter', False):
            ...
            super(MedCareTrainer, self)._save(output_dir, state_dict)
